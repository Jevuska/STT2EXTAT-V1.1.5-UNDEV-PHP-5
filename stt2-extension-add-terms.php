...
Description: <a href="https://wordpress.org/plugins/stt2-extension-add-terms/developers/">UNDEVELOPMENT VERSION</a> - Manage your terms better, add terms into single post manually, get terms via referrer, and save them as post meta. Search the terms that relevant of post content as well as WordPress search default algorithm.
Author: Jevuska
	...
	final class Initial_STT2EXTAT {
		...
		public function setup_constants()
		{
			if ( ! defined( 'STT2EXTAT_VER' ) )
				define( 'STT2EXTAT_VER', '1.1.5-undev' );
