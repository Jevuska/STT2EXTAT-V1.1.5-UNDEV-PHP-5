 ...
 * Min WordPress version 4.4
 * PHP Server version min 5.4
...
== Changelog ==
* 1.1.5-undev = April 22, 2016
 * Fix bug and search excerpt
 
* 1.1.5-undev = December 17, 2015
 * Remove `array_column` in functions.
 * Since `array_column` for object not support for PHP 5, undefined `array_column` for PHP .below 5.5, here Undevelopment Version STT2EXTAT to suppport PHP version min 5.4.
 * Patch function to disable auto update and notification of this plugin.
 * Remove notification PHP version required.
...
== Upgrade Notice ==
= v1.1.5-undev =
Undevelopment version and will not supported for the next development and production, this version created to make it compatible with PHP version minimum 5.4
